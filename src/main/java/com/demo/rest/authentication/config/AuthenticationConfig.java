package com.demo.rest.authentication.config;
...
@DatabaseIdentityStoreDefinition(
        dataSourceLookup = "jdbc/Weaponry",
        callerQuery = "select password from players where login = ?",
        groupsQuery = "select role from players__roles where id = (select id from players where login = ?)",
